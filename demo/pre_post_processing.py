...
class BaseRecLabelDecode(object):
    ...
    def __init__(self,
        ...
        support_character_type = [
            ...
            'ne', 'EN', 'latin', 'arabic', 'cyrillic', 'devanagari','digits'
        ]
    ...
    def decode(self, text_index, text_prob=None, is_remove_duplicate=False):
        ...
        for batch_idx in range(batch_size):
            ...
            for idx in range(len(text_index[batch_idx])):
                ...
                #text_index_origin = text_index[0].copy()
                for j in range(len(text_index)):
                    text_index[j] = [0 if i > 10 else i for i in text_index[j]]
                
                #pdb.set_trace()
                #if any(text_index_origin != text_index[0]):
                #    print("non-digit characters detected")
